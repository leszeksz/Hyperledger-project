...
function createOrg5 {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:11074 --caname ca-org5 --tls.certfiles "${PWD}/fabric-ca/org5/tls-cert.pem"
  { set +x; } 2>/dev/null

  echo 'NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-11074-ca-org5.pem
  ...
  set -x
	fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11074 --caname ca-org5 -M "${PWD}/../organizations/peerOrganizations/org5.example.com/peers/peer0.org5.example.com/msp" --csr.hosts peer0.org5.example.com --tls.certfiles "${PWD}/fabric-ca/org5/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11074 --caname ca-org5 -M "${PWD}/../organizations/peerOrganizations/org5.example.com/peers/peer0.org5.example.com/tls" --enrollment.profile tls --csr.hosts peer0.org5.example.com --csr.hosts localhost --tls.certfiles "${PWD}/fabric-ca/org5/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client enroll -u https://user1:user1pw@localhost:11074 --caname ca-org5 -M "${PWD}/../organizations/peerOrganizations/org5.example.com/users/User1@org5.example.com/msp" --tls.certfiles "${PWD}/fabric-ca/org5/tls-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
	fabric-ca-client enroll -u https://org5admin:org5adminpw@localhost:11074 --caname ca-org5 -M "${PWD}/../organizations/peerOrganizations/org5.example.com/users/Admin@org5.example.com/msp" --tls.certfiles "${PWD}/fabric-ca/org5/tls-cert.pem"
  { set +x; } 2>/dev/null
